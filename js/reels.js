 ...
 <div class="reels_icon">
  <div class="icon">
   <ul>
    ...
    <li><span>···</span></li>
    <li><a href="profile.html"><img src="./img/story_img1.JPG" alt="x"></a></li>
   </ul>
  </div>
 </div>
 <!-- reels_icon end -->
...
Scrap.addEventListener("click",saveClick)
